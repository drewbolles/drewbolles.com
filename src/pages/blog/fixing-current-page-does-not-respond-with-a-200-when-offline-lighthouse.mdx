...
While working on Final Round, I was running lighthouse audit's and was increasingly frustrated by the audit telling me "Current page does not respond with a 200 when offline". This was despite the fact that I had a running Service Worker and a valid Web Manifest file. No matter how I tweaked the setting, I was unable to fix this error. The other frustrating part was I _swore_ this was working not too long ago.
...
<p>
  <img
    src="/images/bypass-for-network-wtf.jpg"
